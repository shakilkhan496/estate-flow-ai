/**
* Theme: Lahome - Responsive Bootstrap 5 Admin Dashboard
* Author: Techzaa
...
class Config {
     ...
     setConfig() {
          ...
          var savedConfig = localStorage.getItem("__Lahome_CONFIG__");
     ...
     init() {
          try {
               ...
               localStorage.setItem('__Lahome_CONFIG__', JSON.stringify(this.config));
               this.setConfig();
          }
     }
}
